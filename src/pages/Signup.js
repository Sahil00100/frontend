...
import {BasicButton, InputBox,Snackbars} from "../components/BasicComponents";
...
function Signup(props) {
  ...
  return (
    <div className="signup-main-container">
      ...
      <p  style={{cursor:"pointer",color:"blue",textAlign:"center"}}><Link to="/login">Already have an account?</Link></p>
